...
<div className={font-sans antialiased min-h-screen relative pb-36 transition-colors duration-300 selection:bg-neutral-800   ${isDarkMode ? 'bg-[#0a0a0a] text-[#A3A3A3]' : 'bg-[#FAFAFA] text-[#525252]'}}
>
...
I want a few things to be added. Make the website exactly EXACTLY LIKE THE VIDEO. just don't change the details. Like name, age and experience. Just add the skills part etc and make it same.
